...
(library Library_1
	...
	(patternDef "SHDR12W87P0X254_1X12_3103X250X" (originalName "SHDR12W87P0X254_1X12_3103X250X")
		(multiLayer
			...
			(pad (padNum 12) (padStyleRef s157.5_h105) (pt 27.94, 0) (rotation 90))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.695 -1.325) (pt -1.695 1.325) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.695 1.325) (pt 29.635 1.325) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 29.635 1.325) (pt 29.635 -1.325) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 29.635 -1.325) (pt -1.695 -1.325) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "PRT-14322" (originalName "PRT-14322") (compHeader (numPins 12) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://cdn.sparkfun.com/datasheets/Prototyping/SP-140520-XX-001.pdf")
